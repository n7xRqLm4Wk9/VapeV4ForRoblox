...
local function downloadFile(path, func)
	if not isfile(path) then
		local suc, res = pcall(function() return game:HttpGet('https://raw.githubusercontent.com/7GrandDadPGN/VapeCompiled/'..readfile('vapetweak/profiles/commit.txt')..'/'..select(1, path:gsub('vapetweak/', '')), true) end)
